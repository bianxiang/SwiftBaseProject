...
//    }
    ...
    static func setRootLoginVC(){
        AppD.loginVC = LoginViewController()
        AppD.window?.rootViewController = AppD.loginVC
    }
    static func setRootMainVC(){
        AppD.mainVC = MainViewController()
        AppD.window?.rootViewController = AppD.mainVC
    }
